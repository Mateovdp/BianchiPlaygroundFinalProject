...
from inicio.views import inicio, crear_empleado, lista, nosotros, contacto, ver_empleado, eliminar_empleado, editar_empleado, login, registro, inicior, perfil, editar_perfil, EditarContrasenia
...
urlpatterns = [
    ...
    path('iniciado/', inicior, name='inicior'),
